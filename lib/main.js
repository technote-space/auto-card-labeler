...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            signale_1.default.info(`Action: ${github_1.context.payload.action}`);
            ...
            signale_1.default.info(`Target project name: ${project}`);
            signale_1.default.info(`Target column name: ${column}`);
